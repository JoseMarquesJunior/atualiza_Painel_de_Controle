...
CAMINHO_ARQUIVO = "dados/Taxa de Rendimento/tx_rend_municipios_2024/tx_rend_municipios_2024.xlsx"

NOME_NOVO_ARQUIVO = 'TaxaRendimento_Municipios2024.xlsx'

print("Iniciando o tratamento da Taxa de Rendimento Municípios 2024...")
